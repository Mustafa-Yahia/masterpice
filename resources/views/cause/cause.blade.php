...
<section class="causes-section-two">
    <div class="auto-container">
        ...
        <form id="filter-form" class="filter-form mb-4">
            <ul class="" style="display: flex; flex-wrap: wrap; align-items: flex-end; justify-content: center; gap: 20px; padding: 20px; margin: 0 0 30px 0; direction: rtl; list-style: none; border-radius: 8px; background: #f9f9f9;">
                    ...
                    <div class="donate-info">
                        <div class="progress-box">
                            <div class="bar">
                                <div class="bar-inner count-bar" data-percent="{{ $cause->raised_amount / $cause->goal_amount * 100 }}%">
                                    <div class="count-text">{{ convertToArabic(number_format($cause->raised_amount / $cause->goal_amount * 100, 0)) }}%</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="link-box">
                            <a href="{{ route('cause.show', $cause->id) }}" class="theme-btn btn-style-two">
                                <span class="btn-title" id="Read_more">اقرأ المزيد</span>
                            </a>
                        </div>
