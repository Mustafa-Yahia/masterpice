                        ...
                        <form action="{{ route('admin.events.update', $event->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <textarea class="form-control" id="description" name="description" rows="1" required>{{ $event->description }}</textarea>
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="url" class="form-control" id="location_url" name="location_url" value="{{ $event->location_url }}">
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" class="form-control" id="volunteers_needed" name="volunteers_needed" min="1" value="{{ $event->volunteers_needed }}" required>
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    @if($event->image)
                                        <div class="mt-2">
                                            <img src="{{ asset('storage/' . $event->image) }}" alt="صورة الحدث" style="max-width: 150px;">
                                        </div>
                                    @endif
                                </div>
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea class="form-control" id="mission" name="mission" rows="2" required>{{ $event->mission }}</textarea>
                                </div>

                                <!-- نقاط المهمة -->
                                <div class="col-md-4 mb-3">
                                    <label for="mission_point_1" class="form-label">نقطة المهمة 1 (اختياري)</label>
                                    <input type="text" class="form-control" id="mission_point_1" name="mission_point_1" value="{{ $event->mission_point_1 }}">
                                </div>

                                <div class="col-md-4 mb-3">
                                    <label for="mission_point_2" class="form-label">نقطة المهمة 2 (اختياري)</label>
                                    <input type="text" class="form-control" id="mission_point_2" name="mission_point_2" value="{{ $event->mission_point_2 }}">
                                </div>

                                <div class="col-md-4 mb-3">
                                    <label for="mission_point_3" class="form-label">نقطة المهمة 3 (اختياري)</label>
                                    <input type="text" class="form-control" id="mission_point_3" name="mission_point_3" value="{{ $event->mission_point_3 }}">
                                </div>
                            </div>
