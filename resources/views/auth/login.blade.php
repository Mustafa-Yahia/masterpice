...
@section('content')
    <section class="login-section" style="padding: 100px 0; direction: rtl; background-image: url('{{ asset('storage/background/Backgroundlogin.png') }}'); background-size: cover; background-position: center center; background-repeat: no-repeat;">
...
<div class="form-group" style="margin-bottom: 20px;">
    ...
    <div class="input-group">
        ...
        <input type="email" id="email" name="email" class="form-control @error('email') is-invalid @enderror"
               value="{{ old('email') ?: request()->cookie('remember_email') }}" required placeholder="أدخل بريدك الإلكتروني">
    </div>
    @error('email')
        <div class="invalid-feedback" style="font-family: 'Cairo', sans-serif; display: block;">{{ $message }}</div>
    @enderror
</div>
...
<div class="form-group" style="margin-bottom: 20px;">
    ...
    <div class="input-group">
        ...
        <input type="password" id="password" name="password" class="form-control @error('password') is-invalid @enderror"
               value="{{ old('password') ?: request()->cookie('remember_password') }}" required placeholder="********">
    </div>
    @error('password')
        <div class="invalid-feedback" style="font-family: 'Cairo', sans-serif; display: block;">{{ $message }}</div>
    @enderror
...
<div class="form-group d-flex justify-content-between" style="margin-top: 20px;">
    <div class="form-check">
        ...
        <label class="form-check-label" for="remember" style="font-family: 'Cairo', sans-serif; margin-right:22px; text-align: right;">
              تذكرني
        </label>
    </div>
    <a href="#" class="text-primary" style="font-family: 'Cairo', sans-serif; color: #007bff;">
