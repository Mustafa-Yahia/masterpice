...
class AdminCauseController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Cause::create($data);  // إنشاء الحملة

        return redirect()->route('admin.causes.index')->with('success', 'تم إضافة الحملة بنجاح!');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.causes.edit', compact('cause'));  // عرض نموذج تعديل الحملة
    }
